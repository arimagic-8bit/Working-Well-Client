    ...
    <div className="page-container">
      ...
      <div className="img-container">
        <div className="section">
          ...
          <p>
            <span className="bold">Manage</span> better your time and get{" "}
            <span className="bold">motivated</span>
          </p>
        </div>
        <div className="section">
          <img src={multitask} alt="A lot of multitasking" />
          <p>
            Forget <span className="bold">multitasking</span> and focus on
            completing <span className="bold">little tasks</span>
          </p>
        </div>
      </div>
    </div>
