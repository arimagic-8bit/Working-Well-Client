...
class LargeBreakScreen extends Component {
  ...
  render() {
    ...
    const isLinkClickable =
      largeBreak === "" ? this.preventClick : this.handleShow;
        ...
        <div className="large-container">
          <div className="blue-container">
            <p className="normal-text spaced">
              Finally, add a <span>large break</span> after you complete all the
              list
            </p>
            <p className="normal-text center">
              <span className="bold">Hint:</span> How about a 20 min rest?
            </p>
            <div className="form">
            ...
            <ModalComplete show={show} />
            {errorMessage && (
              <p className="error-noti">
                You need to write your large break time to continue
              </p>
            )}
          </div>
          <div className="link-container">
            <button className="forward" onClick={isLinkClickable}>
              ➜
            </button>
          </div>
        </div>
